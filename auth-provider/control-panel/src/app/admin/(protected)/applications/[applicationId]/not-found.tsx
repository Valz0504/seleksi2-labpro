...
export default function ApplicationNotFound() {
  return (
    <section className="rounded-xl border border-slate-200 bg-white p-8 text-center shadow-sm">
      ...
      <h2 className="mt-2 text-2xl font-bold text-slate-950">Application tidak ditemukan</h2>
      <p className="mt-3 text-slate-600">ID application tidak terdaftar pada Auth Provider.</p>
      <Link
